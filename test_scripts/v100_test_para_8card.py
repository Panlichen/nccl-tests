...
def setEnv():
    os.environ['LD_LIBRARY_PATH'] = "/data/home/scv7sc1/run/OCCL/ofccl/build/lib:/data/apps/cuda/11.8/lib64"
...
def main():
    ...
    RES_DIR = "./v100_8card_para" 
    if os.path.exists(RES_DIR ):
        os.system("rm -r " + RES_DIR )
    os.mkdir(RES_DIR)
    
    for i in [0,1,2,3,4]:
        runTest(buffer_sizes,[0,1,2,3,4,5],4,i,RES_DIR)
