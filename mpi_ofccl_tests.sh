...
# mpirun -np 2 /home/panlichen/work2/mpi/nccl-tests/build/ofccl_all_reduce_perf -b $2 -e $2 -f 2 -t $1 -g 1 -n 5 -w 2 -c 0
mpirun -np 2 -f machinefile /home/panlichen/work2/mpi/nccl-tests/build/ofccl_all_reduce_perf -b $2 -e $2 -f 2 -t $1 -g 1 -n 5 -w 2 -c 0 #> /home/panlichen/work2/ofccl/log/ofccl.log 2>&1

# mpirun -np 2 -f machinefile /home/panlichen/work2/mpi/nccl-tests/build/all_reduce_perf -b $2 -e $2 -f 2 -t $1 -g 1 -n 5 -w 2 -c 0 #> /home/panlichen/work2/ofccl/log/ofccl.log 2>&1